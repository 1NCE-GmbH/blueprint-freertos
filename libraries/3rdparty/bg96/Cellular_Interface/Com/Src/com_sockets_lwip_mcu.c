...
#define PRINT_INFO(format, args...) \
  TRACE_PRINT(DBG_CHAN_COM, DBL_LVL_P0, "COM: " format "\n\r", ## args)
#define PRINT_DBG(format, args...)  \
  TRACE_PRINT(DBG_CHAN_COM, DBL_LVL_P1, "COM: " format "\n\r", ## args)
#define PRINT_ERR(format, args...)  \
  TRACE_PRINT(DBG_CHAN_COM, DBL_LVL_ERR, "COM ERROR: " format "\n\r", ## args)

#else /* USE_PRINTF == 1 */
#include <stdio.h>
#define PRINT_INFO(format, args...)  \
  (void)printf("COM: " format "\n\r", ## args);
#define PRINT_DBG(format, args...)   \
  (void)printf("COM: " format "\n\r", ## args);
#define PRINT_ERR(format, args...)   \
  (void)printf("COM ERROR: " format "\n\r", ## args);
