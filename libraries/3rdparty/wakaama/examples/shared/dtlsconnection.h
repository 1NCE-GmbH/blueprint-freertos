...
//
//dtls_connection_t * connection_find(dtls_connection_t * connList, const SocketsSockaddr_t * addr, size_t addrLen);
//dtls_connection_t * connection_new_incoming(dtls_connection_t * connList, int sock, const SocketsSockaddr_t * addr, size_t addrLen);
