...
#define mqttdemo_THREAD_PRIO               osPriorityHigh
...
#if (USE_NETEX1 == 1)
#define NETEX1_THREAD_PRIO                 osPriorityNormal
#endif /* (USE_NETEX1 == 1) */
...
#define COM_SOCKETS_STATISTIC (0U) /* 0: not activated,
                                      1: activated */
/*
...
#define USE_TRACE_COM_SOCKETS         (1U) /* DO NOT MODIFY THIS VALUE */
#define USE_TRACE_MQTT_DEMO         (0U) /* DO NOT MODIFY THIS VALUE */
